    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* =========================================================================
              LEFT COLUMN: Value Proposition, Description & Primary CTA
             ========================================================================= */}
          <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6 sm:space-y-8">
            
            {/* Pill Badge (Reference Image 1: "New | Introducing...") */}
            <div 
              id="hero-badge-pill"
              className="inline-flex items-center gap-2.5 px-3 py-1 rounded-full bg-zinc-900/80 hover:bg-zinc-800 border border-white/10 transition-all duration-150 cursor-pointer group"
            ...
            {/* Main Value Proposition Headline - High Contrast Black & White */}
            <h1 
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2 sm:pt-4 w-full sm:w-auto">
              ...
              {/* Primary CTA (Pill with circular arrow button matching reference) */}
              <a
                href="#features"
                id="hero-primary-cta"
          ...
          {/* =========================================================================
              RIGHT COLUMN: Large EMPTY SPACE for 3D Robot Model
             ========================================================================= */}
        ...
        {/* Downward Scroll Indicator (Matching Reference Image 1 bottom-right button) */}
        <div className="hidden sm:flex justify-end mt-6 lg:mt-10">
          <button
            ...
            aria-label="Scroll to value proposition detail"
          >
